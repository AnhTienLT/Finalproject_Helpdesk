...
class AssetSeeder extends Seeder
{
    public function run(): void
    {
        $assets = [
            ...
            ['name' => 'Switch Cisco SG350-28', 'asset_code' => 'NW-001', 'asset_category_id' => 2, 'room_id' => 5, 'status' => 'active', 'purchase_date' => '2023-01-10', 'description' => '28-port Gigabit Managed Switch'],
