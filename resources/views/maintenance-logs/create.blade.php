...
@section('title', 'Thêm log bảo trì')

@section('content')
<div class="max-w-3xl mx-auto bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
        <h3 class="text-lg font-bold text-gray-900">Thêm log bảo trì</h3>
    </div>
    <form action="{{ route('maintenance-logs.store') }}" method="POST" class="p-8 space-y-6">
        @csrf
