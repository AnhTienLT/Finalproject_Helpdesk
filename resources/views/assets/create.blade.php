...
<div class="max-w-3xl mx-auto">
    <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-bold text-gray-900">Thêm tài sản mới</h3>
        </div>

        <form action="{{ route('assets.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            ...
            <div class="pt-4 flex items-center justify-end space-x-3 border-t border-gray-100">
                ...
                <button type="submit" class="px-6 py-2 text-sm font-bold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-700">Lưu tài sản</button>
            </div>
        </form>
    </div>
</div>
