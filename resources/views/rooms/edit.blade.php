...
@section('content')
<h2 class="mb-3">Chỉnh sửa phòng: {{ $room->name }}</h2>
...
<form action="{{ route('rooms.update', $room) }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror"
               value="{{ old('location', $room->location) }}" required maxlength="200">
    ...
    <div class="mb-3">
        ...
        <textarea name="description" id="description" rows="3"
                  ...
                  maxlength="255">{{ old('description', $room->description) }}</textarea>
